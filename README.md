...
Analyze revenue performance on a weekly basis.


Segment customer behavior across different demographics such as age, gender, and income levels.
...
Revenue Growth: Tracked current week revenue vs. previous week revenue using DAX to identify growth trends.


Customer Segmentation: Categorized customers into Low, Medium, and High income groups to understand high-value segments.



Demographic Trends: Visualized how spending habits differ between Male and Female users using dynamic gender filters.
...
Slicers & Filters: Gender, Age Group (18-25, 26-35, etc.), and Income Group.
...
Current Week Revenue vs. Previous Week Revenue.

Calculated Columns for Age Group and Income Group.
...
Weekly Monitoring: Use the weekly status report to identify sudden drops in revenue and investigate specific spending categories that may be underperforming.



Credit Limit Adjustments: Utilize credit score data and transaction history to offer personalized credit limit increases to low-risk, high-spend customers.

🖼️ Dashboard Screenshots
Dashboard 1: Customer Overview
<img width="1920" height="1080" alt="Screenshot 2026-02-10 202854" src="https://github.com/user-attachments/assets/6536b026-4b9f-4f16-a839-074b81060b5b" />



Dashboard 2: Transaction Analysis
<img width="1920" height="1080" alt="Screenshot 2026-02-10 202927" src="https://github.com/user-attachments/assets/fbb20647-ed07-46cb-a057-55c8fe9be43f" />




Project Mentor: Kashish Agrawal
